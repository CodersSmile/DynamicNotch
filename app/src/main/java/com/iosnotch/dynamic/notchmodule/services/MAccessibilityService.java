...
import com.iosnotch.dynamic.notchmodule.adaptar.CustomNotificationAdapter;
//import com.iosnotch.dynamic.notchmodule.adaptar.CustomNotificationIconAdapter;
//import com.iosnotch.dynamic.notchmodule.background.PrefManager;
import com.iosnotch.dynamic.notchmodule.adaptar.CustomNotificationIconAdapter;
import com.iosnotch.dynamic.notchmodule.entity.AppDetail;
import com.iosnotch.dynamic.notchmodule.entity.AppPackageList;
import com.iosnotch.dynamic.notchmodule.entity.Notification;
import com.iosnotch.dynamic.notchmodule.global.Utils;
import com.iosnotch.dynamic.notchmodule.views.CustomRecyclerView;
import com.iosnotch.dynamic.notchmodule.views.StatusBarParentView;
import com.iosnotch.dynamic.utils.Constants;
import com.iosnotch.dynamic.utils.ItemOffsetDecoration2;
...
public class MAccessibilityService extends AccessibilityService {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().matches("android.intent.action.BATTERY_CHANGED")) {
                ...
                if (intExtra == 2 || intExtra == 5) {
                    ...
                    notification.color = MAccessibilityService.this.mContext.getResources().getColor(R.color.green_500);
            ...
            if (intent.getAction().matches("android.media.RINGER_MODE_CHANGED")) {
                ...
                if (dndState != 0 && dndState != 1) {
                    ...
                    if (dndState == 0) {
                        ...
                        notification5.color = MAccessibilityService.this.mContext.getResources().getColor(R.color.red_500);
                    ...
                    if (dndState == 1) {
                        ...
                        notification6.color = MAccessibilityService.this.mContext.getResources().getColor(R.color.purple_400);
                ...
                if (Build.VERSION.SDK_INT < 31 || ActivityCompat.checkSelfPermission(MAccessibilityService.this.mContext, "android.permission.BLUETOOTH_CONNECT") == 0) {
                    if ("android.bluetooth.device.action.ACL_CONNECTED".equals(intent.getAction())) {
                        if (bluetoothDevice.getType() == 1) {
                            ...
                            notification8.color = MAccessibilityService.this.mContext.getResources().getColor(R.color.green_500);
    ...
    public void onServiceConnected() {
        ...
        intentFilter2.addAction(com.iosnotch.dynamic.notchmodule.global.Utils.FROM_NOTIFICATION_SERVICE + this.mContext.getPackageName());
