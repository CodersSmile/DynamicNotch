package com.iosnotch.dynamic.notchmodule.adaptar;
...
import com.iosnotch.dynamic.notchmodule.services.ActionParsable;
import com.iosnotch.dynamic.notchmodule.services.MAccessibilityService;
import com.iosnotch.dynamic.notchmodule.services.NotificationListener;
...
public class CustomNotificationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void updateMediaProgress() {
        int absoluteAdapterPosition = this.mediaViewHolder.getAdapterPosition();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final ArrayList<Notification> arrayList) {
            ...
            final Notification notification = arrayList.get(this.holder.getAdapterPosition());
            ...
            this.holder.itemView.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    try {
                        if (((Notification) arrayList.get(ViewHolder.this.holder.getAdapterPosition())).pendingIntent != null) {
                            ((Notification) arrayList.get(ViewHolder.this.holder.getAdapterPosition())).pendingIntent.send();
                            CustomNotificationAdapter.this.notificationListener.onItemClicked((Notification) arrayList.get(ViewHolder.this.holder.getAdapterPosition()));
                        }
                        if (((Notification) arrayList.get(ViewHolder.this.holder.getAdapterPosition())).isClearable) {
                            arrayList.remove(ViewHolder.this.holder.getAdapterPosition());
            ...
            if (arrayList.get(this.holder.getAdapterPosition()).actions == null || arrayList.get(this.holder.getAdapterPosition()).actions.size() <= 0) {
                ...
                if (notification.template.equals("MediaStyle")) {
                    ...
                    String access$1100 = CustomNotificationAdapter.this.getFormattedTime(arrayList.get(this.holder.getAdapterPosition()).duration);
                    String access$11002 = CustomNotificationAdapter.this.getFormattedTime(arrayList.get(this.holder.getAdapterPosition()).position);
            ...
            this.holder.arrow_iv.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    int absoluteAdapterPosition = ViewHolder.this.holder.getAdapterPosition();
                    if (absoluteAdapterPosition >= 0 && absoluteAdapterPosition < arrayList.size()) {
                        if (ViewHolder.this.holder.notification_action_container.getVisibility() == 0) {
                            ...
                            ViewHolder.this.holder.sub_text.setText(((Notification) arrayList.get(ViewHolder.this.holder.getAdapterPosition())).tv_text.toString());
                        ...
                        if (!notification.bigText.toString().isEmpty()) {
                            ViewHolder.this.holder.sub_text.setText(((Notification) arrayList.get(ViewHolder.this.holder.getAdapterPosition())).bigText.toString());
                        }
    ...
    public class ViewHolderCall extends RecyclerView.ViewHolder {
        ...
        public void bind(final ArrayList<Notification> arrayList) {
            ...
            this.viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    try {
                        if (((Notification) arrayList.get(ViewHolderCall.this.viewHolder.getAdapterPosition())).pendingIntent != null) {
                            ((Notification) arrayList.get(ViewHolderCall.this.viewHolder.getAdapterPosition())).pendingIntent.send();
                            CustomNotificationAdapter.this.notificationListener.onItemClicked((Notification) arrayList.get(ViewHolderCall.this.viewHolder.getAdapterPosition()));
                        }
                        if (((Notification) arrayList.get(ViewHolderCall.this.viewHolder.getAdapterPosition())).isClearable) {
                            arrayList.remove(ViewHolderCall.this.viewHolder.getAdapterPosition());
                            CustomNotificationAdapter.this.notifyDataSetChanged();
                        }
                        ((MAccessibilityService) CustomNotificationAdapter.this.mContext).closeFullNotificationIsland();
                    } catch (Exception e) {
